...
public class Test {
  ...
  public static void comprobarParaEscribir(
    DonacionRopa donacion,
    Interfaz vista
  ) {
    if (donacion.getCantidad() > 1) vista.mostrar(
      "Se construyeron " + donacion.getCantidad() + " " + donacion.getTipo()
    ); else vista.mostrar(
      "Se construyo " + donacion.getCantidad() + " " + donacion.getTipo()
    );
